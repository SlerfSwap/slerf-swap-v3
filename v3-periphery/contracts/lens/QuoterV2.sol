...
import '../core/interfaces/callback/ISlerfSwapV3SwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, ISlerfSwapV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for ISlerfSwapV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (ISlerfSwapV3Pool) {
        return ISlerfSwapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc ISlerfSwapV3SwapCallback
    function uniswapV3SwapCallback(
        ...
        ISlerfSwapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ISlerfSwapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
